        ...
        <main id="main-content">
            <div class="lg:hidden" x-data="{ openMenu: false }">
                ...
                >
                    ...
                    <!-- Opciones del menú -->
                    <a href="#" class="text-gray-600 text-xl hover:text-gray-900"
                        >Panel principal</a
                    >
                    <a href="#" class="text-gray-600 text-xl hover:text-gray-900"
                        >Compañias</a
                    ...
                    <a href="#" class="text-gray-600 text-xl hover:text-gray-900"
                        >Perfil</a
                    >
                    <a href="#" class="text-gray-600 text-xl hover:text-gray-900"   id="logoutButton" 
                        >Finalizar sesión</a
                    >
                </div>
            </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            >
                                ...
                                <a
                                    href="#"
                                    class="block px-4 py-2 text-gray-700 hover:bg-gray-100"   id="logoutButton" 
                                    >Finalizar sesión</a
                                >
                            </div>
                        </div>
            ...
            <div class="bg-white mt-0 p-4">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-semibold text-gray-800">Emitir nota de credito</h1>
                </div>
            </div>
